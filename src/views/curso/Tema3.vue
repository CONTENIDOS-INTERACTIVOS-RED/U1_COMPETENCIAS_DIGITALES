    ...
    .row.bg-azul-1.bg-full-width.py-4.mb-5
      div.px-5.pb-md-3.py-4.d-flex
        .col-12.col-xl-7.col-xxl-8.d-flex.pe-4.pe-xl-5.align-items-center.flex-column
          ...
          a.mt-4.d-flex.me-auto.bg-white.box-shadow.cursor-pointer(style="width: 340px" :href="obtenerLink('/downloads/Anexo_Herramientas_tecnológicas_para_la_gestión_del_tiempo.pdf')" target="_blank")
